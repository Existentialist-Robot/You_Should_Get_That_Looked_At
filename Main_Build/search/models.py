...
class Upload(models.Model):
    ...
    thumb = models.ImageField(upload_to='search/%Y/%m/%d' ,max_length=IMAGE_MAX_LENGTH,  default="default.png") #
    author = models.ForeignKey(User,on_delete=models.CASCADE, default=None)# associate a model with the user
...
#
    def __str__(self):
        return 'Comment by {} on {}'.format(self.author, self.blog)
